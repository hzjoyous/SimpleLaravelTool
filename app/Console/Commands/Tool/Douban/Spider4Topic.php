...
//        $result = DouBanTopic::all();
     ...
     */
    public function sListUse(bool $useRightInputLeftOut = true)
    {
        $count        = 0;
        $topicInfoStr = '';
        $retry        = 0;
...
//                    $this->info($e->getTraceAsString());
    ...
    protected function useContent($content, $topicId, $groupId = 0, $nowPageNumber = 0): void
    {
